<template>
  <div class="musicPlay">
    ...
    <div id="songDetail" v-show="musicDetail.al.picUrl !== ''">
      ...
      <div id="songName">
        <span
          style="color: #fff; cursor: pointer; margin-left: 10px; margin-right: 4px"
    ...
    <!-- 播放进度条 -->
    <span class="playTime playTime_left">{{
    ...
    <span class="playTime playTime_right">{{
...
.musicPlay {
  position: fixed;
  box-shadow: 0 0 1px 1px rgba(162, 13, 15);
  bottom: 0;
  width: 100%;
  height: 80px;
  background: rgba(162, 13, 15, 0.85);
  z-index: 3000;
  color: #ddd;
}
/* 音乐操作 */
...
.musicPlay #play:hover,
.musicPlay #pause:hover {
  background: #ddddde;
}
...
.musicPlay #playOrd:hover,
.musicPlay #backSong:hover,
.musicPlay #nextSong:hover,
.musicPlay #album:hover {
  color: #ed6566;
}
...
.musicPlay #songName:hover,
.musicPlay #authorName:hover {
  opacity: 1;
}
...
.musicPlay .volume .el-slider__button{
  width:8px !important; 
...
.musicPlay .volume .el-slider__runway,
.musicPlay .el-slider__runway{
  background:rgba(255,255,255,.2);
}
.musicPlay .el-slider__bar{
  background-color: rgba(255,255,255,.5);
}
.musicPlay .playTime_left {
  right: 72.5%;
}

.musicPlay .playTime_right {
  left: 72.5%;
}
</style>
